...
char const info_version_internal[] = { 'I', 'N', 'F', 'O', ':', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '_', 'v', 'e',
...
#if (defined(__clang__) || defined(__GNUC__) || defined(__TI_COMPILER_VERSION__)) && !defined(__STRICT_ANSI__) && !defined(_MSC_VER)
                                               "ON"
#else
                                               "OFF"
#endif
